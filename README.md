...
- 🔗 **Deep Links** — Открытие ссылок rutube.ru прямо в приложении
...
<!--
  КАК ДОБАВИТЬ СКРИНШОТЫ — см. инструкцию в разделе ниже.
-->

| Главная | Плеер | Библиотека | Настройки |
|---------|-------|------------|-----------|
| <img src="screenshots/home.png" width="200"/> | <img src="screenshots/player.png" width="200"/> | <img src="screenshots/library.png" width="200"/> | <img src="screenshots/settings.png" width="200"/> |

> Если скриншотов ещё нет — см. раздел [Как добавить скриншоты](#-как-добавить-скриншоты) ниже.
...
Скриншоты делают README красивым и помогают понять, что за приложение, до установки.
...
2. Сделайте скриншоты. Способы:
   - **Эмулятор Android Studio** — нажмите 📷 на боковой панели эмулятора
   - **Телефон** — обычная комбинация (Power + Vol Down)
   - **ADB** — `adb exec-out screencap -p > screenshots/home.png`

3. Сохраните файлы с этими именами (README ссылается именно на них):

   | Файл | Что снять |
   |------|----------|
   | `screenshots/home.png` | Главный экран с лентой видео |
   | `screenshots/player.png` | Плеер с открытым видео |
   | `screenshots/library.png` | Библиотека (история, лайки, плейлисты) |
...
> **Совет:** делайте на эмуляторе Pixel 7 (1080×2400) в тёмной теме — выглядит единообразно и современно.
